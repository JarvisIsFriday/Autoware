                         ...
                         int* obstacle_waypoint, ObstaclePoints* obstacle_points)
{
  ...
  int stop_obstacle_waypoint =
    detectStopObstacle(points, objects, closest_waypoint, lane, crosswalk_manager, vs_info.getStopRange(),
...
{
  ObstaclePoints obstacle_points;
  EControl detection_result = pointsDetection(vs_info.getPoints(), vs_info.getObjects(), closest_waypoint, lane, crosswalk_manager, vs_info,
